...
SENSOR_MONITOR_CONFIG = [
	...
	['/org/openbmc/sensors/pmbus/pmbus01/fan', { 'object_path' : '/sys/class/hwmon/hwmon1/fan1_input','poll_interval' : 10000,'scale' : 1,'units' : 'rpm','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/temp_01', { 'object_path' : '/sys/class/hwmon/hwmon1/temp1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/temp_02', { 'object_path' : '/sys/class/hwmon/hwmon1/temp2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/temp_03', { 'object_path' : '/sys/class/hwmon/hwmon1/temp3_input','poll_interval' : 10000,'scale' : 1000, 'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/Voltage_vin', { 'object_path' : '/sys/class/hwmon/hwmon1/in1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/Voltage_vout', { 'object_path' : '/sys/class/hwmon/hwmon1/in2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/Current_iin', { 'object_path' : '/sys/class/hwmon/hwmon1/curr1_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/Current_iout', { 'object_path' : '/sys/class/hwmon/hwmon1/curr2_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/Power_pin', { 'object_path' : '/sys/class/hwmon/hwmon1/power1_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus01/Power_pout', { 'object_path' : '/sys/class/hwmon/hwmon1/power2_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/fan', { 'object_path' : '/sys/class/hwmon/hwmon2/fan1_input','poll_interval' : 10000,'scale' : 1,'units' : 'rpm','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/temp_01', { 'object_path' : '/sys/class/hwmon/hwmon2/temp1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/temp_02', { 'object_path' : '/sys/class/hwmon/hwmon2/temp2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/temp_03', { 'object_path' : '/sys/class/hwmon/hwmon2/temp3_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/Voltage_vin', { 'object_path' : '/sys/class/hwmon/hwmon2/in1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/Voltage_vout', { 'object_path' : '/sys/class/hwmon/hwmon2/in2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/Current_iin', { 'object_path' : '/sys/class/hwmon/hwmon2/curr1_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/Current_iout', { 'object_path' : '/sys/class/hwmon/hwmon2/curr2_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/Power_pin', { 'object_path' : '/sys/class/hwmon/hwmon2/power1_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus02/Power_pout', { 'object_path' : '/sys/class/hwmon/hwmon2/power2_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/fan', { 'object_path' : '/sys/class/hwmon/hwmon3/fan1_input','poll_interval' : 10000,'scale' : 1,'units' : 'rpm','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/temp_01', { 'object_path' : '/sys/class/hwmon/hwmon3/temp1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/temp_02', { 'object_path' : '/sys/class/hwmon/hwmon3/temp2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/temp_03', { 'object_path' : '/sys/class/hwmon/hwmon3/temp3_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/Voltage_vin', { 'object_path' : '/sys/class/hwmon/hwmon3/in1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/Voltage_vout', { 'object_path' : '/sys/class/hwmon/hwmon3/in2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/Current_iin', { 'object_path' : '/sys/class/hwmon/hwmon3/curr1_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/Current_iout', { 'object_path' : '/sys/class/hwmon/hwmon3/curr2_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/Power_pin', { 'object_path' : '/sys/class/hwmon/hwmon3/power1_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus03/Power_pout', { 'object_path' : '/sys/class/hwmon/hwmon3/power2_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/fan', { 'object_path' : '/sys/class/hwmon/hwmon4/fan1_input','poll_interval' : 10000,'scale' : 1,'units' : 'rpm','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/temp_01', { 'object_path' : '/sys/class/hwmon/hwmon4/temp1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/temp_02', { 'object_path' : '/sys/class/hwmon/hwmon4/temp2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/temp_03', { 'object_path' : '/sys/class/hwmon/hwmon4/temp3_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/Voltage_vin', { 'object_path' : '/sys/class/hwmon/hwmon4/in1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/Voltage_vout', { 'object_path' : '/sys/class/hwmon/hwmon4/in2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/Current_iin', { 'object_path' : '/sys/class/hwmon/hwmon4/curr1_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/Current_iout', { 'object_path' : '/sys/class/hwmon/hwmon4/curr2_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/Power_pin', { 'object_path' : '/sys/class/hwmon/hwmon4/power1_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus04/Power_pout', { 'object_path' : '/sys/class/hwmon/hwmon4/power2_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/fan', { 'object_path' : '/sys/class/hwmon/hwmon5/fan1_input','poll_interval' : 10000,'scale' : 1,'units' : 'rpm','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/temp_01', { 'object_path' : '/sys/class/hwmon/hwmon5/temp1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/temp_02', { 'object_path' : '/sys/class/hwmon/hwmon5/temp2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/temp_03', { 'object_path' : '/sys/class/hwmon/hwmon5/temp3_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/Voltage_vin', { 'object_path' : '/sys/class/hwmon/hwmon5/in1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/Voltage_vout', { 'object_path' : '/sys/class/hwmon/hwmon5/in2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/Current_iin', { 'object_path' : '/sys/class/hwmon/hwmon5/curr1_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/Current_iout', { 'object_path' : '/sys/class/hwmon/hwmon5/curr2_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/Power_pin', { 'object_path' : '/sys/class/hwmon/hwmon5/power1_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus05/Power_pout', { 'object_path' : '/sys/class/hwmon/hwmon5/power2_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/fan', { 'object_path' : '/sys/class/hwmon/hwmon6/fan1_input','poll_interval' : 10000,'scale' : 1,'units' : 'rpm','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/temp_01', { 'object_path' : '/sys/class/hwmon/hwmon6/temp1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/temp_02', { 'object_path' : '/sys/class/hwmon/hwmon6/temp2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/temp_03', { 'object_path' : '/sys/class/hwmon/hwmon6/temp3_input','poll_interval' : 10000,'scale' : 1000,'units' : 'C','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/Voltage_vin', { 'object_path' : '/sys/class/hwmon/hwmon6/in1_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/Voltage_vout', { 'object_path' : '/sys/class/hwmon/hwmon6/in2_input','poll_interval' : 10000,'scale' : 1000,'units' : 'V','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/Current_iin', { 'object_path' : '/sys/class/hwmon/hwmon6/curr1_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/Current_iout', { 'object_path' : '/sys/class/hwmon/hwmon6/curr2_input','poll_interval' : 10000,'scale' : 1,'units' : 'mA','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/Power_pin', { 'object_path' : '/sys/class/hwmon/hwmon6/power1_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
	['/org/openbmc/sensors/pmbus/pmbus06/Power_pout', { 'object_path' : '/sys/class/hwmon/hwmon6/power2_input','poll_interval' : 10000,'scale' : 1000000,'units' : 'W','value' : 0}],
]
