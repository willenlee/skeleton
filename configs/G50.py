...
SENSOR_MONITOR_CONFIG = [
    ['/org/openbmc/sensors/gpu/gpu1_temp', {
        'object_path':'sensors/gpu/gpu1_temp',
        'device_node' : '/tmp/gpu/gpu1_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu2_temp', {
        'object_path':'sensors/gpu/gpu2_temp',
        'device_node' : '/tmp/gpu/gpu2_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu3_temp', {
        'object_path':'sensors/gpu/gpu3_temp',
        'device_node' : '/tmp/gpu/gpu3_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu4_temp', {
        'object_path':'sensors/gpu/gpu4_temp',
        'device_node' : '/tmp/gpu/gpu4_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu5_temp', {
        'object_path':'sensors/gpu/gpu5_temp',
        'device_node' : '/tmp/gpu/gpu5_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu6_temp', {
        'object_path':'sensors/gpu/gpu6_temp',
        'device_node' : '/tmp/gpu/gpu6_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu7_temp', {
        'object_path':'sensors/gpu/gpu7_temp',
        'device_node' : '/tmp/gpu/gpu7_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/sensors/gpu/gpu8_temp', {
        'object_path':'sensors/gpu/gpu8_temp',
        'device_node' : '/tmp/gpu/gpu8_temp',
        'poll_interval' : 5000,
        'scale' : 1,
        'units' : 'C',
        'critical_upper':81,
    ...
    ['/org/openbmc/control/fan/pwm1', {
        'object_path':'control/fan/pwm1',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/pwm1_falling',
        'poll_interval' : 10000,
        'scale' : 1,
        'value' : 0,
        'units':'%',
    ...
    ['/org/openbmc/control/fan/pwm2', {
        'object_path':'control/fan/pwm2',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/pwm2_falling',
        'poll_interval' : 10000,
        'scale' : 1,
        'value' : 0,
        'units':'%',
    ...
    ['/org/openbmc/control/fan/pwm3', {
        'object_path':'control/fan/pwm3',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/pwm3_falling',
        'poll_interval' : 10000,
        'scale' : 1,
        'value' : 0,
        'units':'%',
    ...
    ['/org/openbmc/control/fan/pwm4', {
        'object_path':'control/fan/pwm4',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/pwm4_falling',
        'poll_interval' : 10000,
        'scale' : 1,
        'value' : 0,
        'units':'%',
    ...
    ['/org/openbmc/control/fan/pwm5', {
        'object_path':'control/fan/pwm5',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/pwm5_falling',
        'poll_interval' : 10000,
        'scale' : 1,
        'value' : 0,
        'units':'%',
    ...
    ['/org/openbmc/control/fan/pwm6', {
        'object_path':'control/fan/pwm6',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/pwm6_falling',
        'poll_interval' : 10000,
        'scale' : 1,
        'value' : 0,
        'units':'%',
    ...
    ['/org/openbmc/sensors/fan/fan_tacho1', {
        'object_path':'sensors/fan/fan_tacho1',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho1_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho2', {
        'object_path':'sensors/fan/fan_tacho2',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho2_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho3', {
        'object_path':'sensors/fan/fan_tacho3',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho3_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho4', {
        'object_path':'sensors/fan/fan_tacho4',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho4_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho5', {
        'object_path':'sensors/fan/fan_tacho5',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho5_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho6', {
        'object_path':'sensors/fan/fan_tacho6',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho6_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho7', {
        'object_path':'sensors/fan/fan_tacho7',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho7_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho8', {
        'object_path':'sensors/fan/fan_tacho8',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho8_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho9', {
        'object_path':'sensors/fan/fan_tacho9',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho9_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho10', {
        'object_path':'sensors/fan/fan_tacho10',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho10_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho11', {
        'object_path':'sensors/fan/fan_tacho11',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho11_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/fan/fan_tacho12', {
        'object_path':'sensors/fan/fan_tacho12',
        'device_node' : '/sys/devices/platform/ast_pwm_tacho.0/tacho12_rpm',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : 'rpm',
        'value' : 0,
    ...
    ['/org/openbmc/sensors/pmbus/pmbus01/temp_02', {
        'bus_number':'8-0058',
        'object_path':'sensors/pmbus/pmbus01/temp_02',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus01/Voltage_vout', {
        'bus_number':'8-0058',
        'object_path':'sensors/pmbus/pmbus01/Voltage_vout',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus01/Power_pout', {
        'bus_number':'8-0058',
        'object_path':'sensors/pmbus/pmbus01/Power_pout',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus02/temp_02', {
        'bus_number':'9-0058',
        'object_path':'sensors/pmbus/pmbus02/temp_02',
        'device_node' : 'temp2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'C',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus02/Voltage_vout', {
        'bus_number':'9-0058',
        'object_path':'sensors/pmbus/pmbus02/Voltage_vout',
        'device_node' : 'in2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'V',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus02/Power_pout', {
        'bus_number':'9-0058',
        'object_path':'sensors/pmbus/pmbus02/Power_pout',
        'device_node' : 'power2_input',
        'poll_interval' : 10000,
        'scale' : 1000000,
        'units' : 'W',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus03/temp_02', {
        'bus_number':'10-0058',
        'object_path':'sensors/pmbus/pmbus03/temp_02',
        'device_node' : 'temp2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'C',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus03/Voltage_vout', {
        'bus_number':'10-0058',
        'object_path':'sensors/pmbus/pmbus03/Voltage_vout',
        'device_node' : 'in2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'V',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus03/Power_pout', {
        'bus_number':'10-0058',
        'object_path':'sensors/pmbus/pmbus03/Power_pout',
        'device_node' : 'power2_input',
        'poll_interval' : 10000,
        'scale' : 1000000,
        'units' : 'W',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus04/temp_02', {
        'bus_number':'11-0058',
        'object_path':'sensors/pmbus/pmbus04/temp_02',
        'device_node' : 'temp2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'C',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus04/Voltage_vout', {
        'bus_number':'11-0058',
        'object_path':'sensors/pmbus/pmbus04/Voltage_vout',
        'device_node' : 'in2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'V',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus04/Power_pout', {
        'bus_number':'11-0058',
        'object_path':'sensors/pmbus/pmbus04/Power_pout',
        'device_node' : 'power2_input',
        'poll_interval' : 10000,
        'scale' : 1000000,
        'units' : 'W',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus05/temp_02', {
        'bus_number':'12-0058',
        'object_path':'sensors/pmbus/pmbus05/temp_02',
        'device_node' : 'temp2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'C',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus05/Voltage_vout', {
        'bus_number':'12-0058',
        'object_path':'sensors/pmbus/pmbus05/Voltage_vout',
        'device_node' : 'in2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'V',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus05/Power_pout', {
        'bus_number':'12-0058',
        'object_path':'sensors/pmbus/pmbus05/Power_pout',
        'device_node' : 'power2_input',
        'poll_interval' : 10000,
        'scale' : 1000000,
        'units' : 'W',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus06/temp_02', {
        'bus_number':'13-0058',
        'object_path':'sensors/pmbus/pmbus06/temp_02',
        'device_node' : 'temp2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'C',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus06/Voltage_vout', {
        'bus_number':'13-0058',
        'object_path':'sensors/pmbus/pmbus06/Voltage_vout',
        'device_node' : 'in2_input',
        'poll_interval' : 10000,
        'scale' : 1000,
        'units' : 'V',
    ...
    ['/org/openbmc/sensors/pmbus/pmbus06/Power_pout', {
        'bus_number':'13-0058',
        'object_path':'sensors/pmbus/pmbus06/Power_pout',
        'device_node' : 'power2_input',
        'poll_interval' : 10000,
        'scale' : 1000000,
        'units' : 'W',
    ...
    ['/org/openbmc/control/cable_led/led0', {
        'object_path':'control/cable_led/led0',
        'device_node' : '/sys/class/gpio/gpio234/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led1', {
        'object_path':'control/cable_led/led1',
        'device_node' : '/sys/class/gpio/gpio235/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led2', {
        'object_path':'control/cable_led/led2',
        'device_node' : '/sys/class/gpio/gpio242/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led3', {
        'object_path':'control/cable_led/led3',
        'device_node' : '/sys/class/gpio/gpio243/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led4', {
        'object_path':'control/cable_led/led4',
        'device_node' : '/sys/class/gpio/gpio250/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led5', {
        'object_path':'control/cable_led/led5',
        'device_node' : '/sys/class/gpio/gpio251/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led6', {
        'object_path':'control/cable_led/led6',
        'device_node' : '/sys/class/gpio/gpio258/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led7', {
        'object_path':'control/cable_led/led7',
        'device_node' : '/sys/class/gpio/gpio259/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led8', {
        'object_path':'control/cable_led/led8',
        'device_node' : '/sys/class/gpio/gpio266/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led9', {
        'object_path':'control/cable_led/led9',
        'device_node' : '/sys/class/gpio/gpio267/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led10', {
        'object_path':'control/cable_led/led10',
        'device_node' : '/sys/class/gpio/gpio274/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led11', {
        'object_path':'control/cable_led/led11',
        'device_node' : '/sys/class/gpio/gpio275/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led12', {
        'object_path':'control/cable_led/led12',
        'device_node' : '/sys/class/gpio/gpio282/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led13', {
        'object_path':'control/cable_led/led13',
        'device_node' : '/sys/class/gpio/gpio283/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led14', {
        'object_path':'control/cable_led/led14',
        'device_node' : '/sys/class/gpio/gpio290/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/control/cable_led/led15', {
        'object_path':'control/cable_led/led15',
        'device_node' : '/sys/class/gpio/gpio291/value',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':True,
    ...
    ['/org/openbmc/sensors/pex/pex0', {
        'object_path':'sensors/pex/pex0',
        'device_node' : '/tmp/pex/pex0_temp',
        'poll_interval' : 10000,
        'scale' : 1,
        'units' : '',
        'standby_monitor':False,
    ...
    ['/org/openbmc/sensors/bmc_health', {
